...
Node.js (Versión LTS recomendada) -> Descargar Node.js
Git -> Descargar Git
Expo Go (App en tu celular) -> Descárgala desde la App Store (iOS) o Google Play Store (Android).
...
cd INGEDEMOCRATICOS
#Instalar dependencias base del paquete de Node npm install
