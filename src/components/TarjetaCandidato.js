  ...
  if (!isFeedMode) {
    return (
      ...
      <TouchableOpacity 
        ...
        activeOpacity={0.7}
        onPress={() => onVerDetalles && onVerDetalles(item)}
      >
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.floatingButtons}>
        ...
        <TouchableOpacity style={styles.circleButton} onPress={() => Alert.alert("Guardado en favoritos")}><Text style={{ fontSize: 20 }}>🔖</Text></TouchableOpacity>
      </View>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  floatingButtons: { position: 'absolute', bottom: 15, right: 15, flexDirection: 'column', gap: 10, zIndex: 1 },
  circleButton: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', elevation: 4, shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 5 },
  miniCard: { flexDirection: 'row', backgroundColor: '#FFFFFF', width: width * 0.92, padding: 12, borderRadius: 18, alignItems: 'center', elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, shadowOffset: { width: 0, height: 2 }, alignSelf: 'center', borderWidth: 1, borderColor: '#F3F4F6' },
  miniImage: { width: 55, height: 55, borderRadius: 14, backgroundColor: '#eee', borderWidth: 1, borderColor: '#D4AF37' },
